...
Label(root, textvariable=zuse_text_list[2], bg='green', width=10, height=2).grid(
    row=2, column=4)
Label(root, textvariable=zuse_text_list[3], bg='green', width=10, height=2).grid(
    row=2, column=5)
...
Label(root, textvariable=wait_text_list[2], bg='green', width=10, height=2).grid(
    row=3, column=4)
Label(root, textvariable=wait_text_list[3], bg='green', width=10, height=2).grid(
    row=3, column=5)
